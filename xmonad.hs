...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_o), spawn $ "xdg-open \"$(fd --type f --glob '*' /home/chachi/Uni | dmenu -i -f --nb '#191919' --nf '#fea63c' --sb '#fea63c' --sf '#191919' --font 'FiraCode Nerd Font Mono:bold:pixelsize=14' --render_minheight 30 -p 'Open')\"" )
  , ((modMask, xK_q), kill )
